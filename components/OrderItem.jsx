      ...
      <tr className="text-sm">
            ...
            {order.items.map((item, index) => (
              <div key={index} className="flex items-center gap-4">
                ...
                <div className="flex flex-col justify-center text-sm">
                  ...
                  <p>
                    {currency}
                    {item.product.price.toLocaleString()} Qty :{" "}
                    {item.quantity}{" "}
                  </p>
                  <p className="mb-1">
                  ...
                  <div>
                    {ratings.find(
                      ...
                      <button
                        ...
                        className={`text-green-500 hover:bg-green-50 transition ${order.orderStatus !== "delivered" && "hidden"}`}
                      >
                        Rate Product
                      </button>
                    )}
        ...
        <td className="text-left space-y-2 text-sm max-md:hidden">
          ...
          >
            ...
            {order.orderStatus.split("_").join(" ").toLowerCase()}
          </div>
        </td>
      </tr>
      {/* Mobile */}
