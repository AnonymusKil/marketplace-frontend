...
import { ADMIN_PROFILE } from "@/src/graphql/mutations/adminDashboard";
...
const AdminSidebar = () => {
  ...
  const adminData = data?.getAdminDashboardProfile || null;
  ...
  return (
    <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
      <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
        ...
        <p className="text-slate-700">Hi, {adminData?.name}</p>
      </div>
