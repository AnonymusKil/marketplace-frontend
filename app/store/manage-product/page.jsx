...
import { GET_MY_SELLER_PRODUCTS} from "../../../src/graphql/mutations/product";
...
export default function StoreManageProducts() {
  ...
  const { data, loading } = useQuery(GET_MY_SELLER_PRODUCTS);
  const products = data?.mysellerProducts || [];
